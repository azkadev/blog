...
import 'package:blog/scheme/account_data.dart';
...
class SponsorBlogWidget extends StatefulWidget {
  final List<AccountData> sponsor;
  const SponsorBlogWidget({super.key, required this.sponsor});

  @override
  State<SponsorBlogWidget> createState() => _SponsorBlogWidgetState();
}

class _SponsorBlogWidgetState extends State<SponsorBlogWidget> {
  @override
    ...
    return Padding(
      ...
      child: Row(
        ...
        children: [
          Padding(
            padding: const EdgeInsets.all(5),
            child: ProfilePictureBlogWidget(
