...
class ListWithBlogWidget extends StatefulWidget {
  ...
  @override
  State<ListWithBlogWidget> createState() => _ListWithBlogWidgetState();
}

class _ListWithBlogWidgetState extends State<ListWithBlogWidget> {
  @override
